 ...
 * method that is invoked by LwEventManager to test if input events for the child component
 * should be caught by the parent component.
 */
...
extends LwContainer
{
  ...
  * @param <code>child</code> the specified child component.
