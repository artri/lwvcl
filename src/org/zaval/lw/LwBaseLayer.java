  ...
  */
  public LwBaseLayer(Object id) {
   ...
   public /*C#virtual*/ void setupFocus() {
     if (prevFocusOwner != null) LwToolkit.getFocusManager().requestFocus(prevFocusOwner);
     else LwToolkit.getFocusManager().requestFocus(LwToolkit.getFocusManager().findFocusable(this));
   }
