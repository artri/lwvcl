...
extends LwAWTEvent
{
  ...
  */
  public static final int COMP_ADDED   = 104;

 /**
  * The component removed event type.
  */
  public static final int COMP_REMOVED = 105;

  private LwContainer parent;
  ...
  * @param <code>p</code> the parent container, where the specified source has been added
  * or removed.
  * @param <code>id</code> the specified event id.
  */
  public LwContainerEvent(LwComponent target, LwContainer p, int id) {
    super(target, id);
    parent = p;
  }
