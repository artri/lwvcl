...
/**
 * This is a utility class that can be used by a class that generates LwFocusEvent to support
 * list of LwFocusListener classes.
 */
public class LwFocusSupport
extends org.zaval.util.event.ListenerSupport
{
  ...
  * specified listener. In this case the class is used to delivery the LwFocusEvent
  * to the LwFocusListener.
  ...
  */
  public /*C#override*/ void perform(EventListener l, EventObject e) {
    process((LwFocusListener)l, (LwFocusEvent)e);
  }

  protected static void process (LwFocusListener l, LwFocusEvent e) {
