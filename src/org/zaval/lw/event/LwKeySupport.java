...
/**
 * This is a utility class that can be used by a class that generates LwKeyEvent to support
 * list of LwKeyListener classes.
 */
public class LwKeySupport
extends org.zaval.util.event.ListenerSupport
{
  ...
  * specified listener. In this case the class is used to delivery the LwKeyEvent
  * to the LwKeyListener.
  ...
  */
  public /*C#override*/ void perform(EventListener l, EventObject e) {
    process((LwKeyListener)l, (LwKeyEvent)e);
  }

  protected static void process (LwKeyListener l, LwKeyEvent e)
  {
    switch (e.getID())
    {
