 ...
 */
public class LwComponentEvent
extends LwAWTEvent
{
 /**
  * The component disabled event type.
  */
  public static final int COMP_DISABLED = 100;

 /**
  * The component enabled event type.
  */
  public static final int COMP_ENABLED  = 101;

 /**
  * The component shown event type.
  */
  public static final int COMP_SHOWN    = 102;

 /**
  * The component hidden event type.
  */
  public static final int COMP_HIDDEN   = 103;
  ...
  */
  public LwComponentEvent(LwComponent target, int id) {
    super(target, id);
  }
