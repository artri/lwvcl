...
/**
 * This is a utility class that can be used by a class that generates LwActionEvent to support
...
extends org.zaval.util.event.ListenerSupport
{
  ...
  * specified listener. In this case the class is used to delivery the LwActionEvent
  * to the LwActionListener.
  ...
  */
  public /*C#override*/ void perform(EventListener l, EventObject e){
    ((LwActionListener)l).actionPerformed ((LwActionEvent)e);
  }
}
