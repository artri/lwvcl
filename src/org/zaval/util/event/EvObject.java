...
extends java.util.EventObject
{
  ...
  */
  public EvObject(Object src, int id)
  {
    super(src);
    if (!checkID(id)) throw new IllegalArgumentException();
    this.id = id;
  }
 ...
 /**
  * The method returns <code>true</code> if the specified id is valid for the event,
  * otherwise returns <code>false</code>. The method is called with the event constructor
  * to test if the event id is valid and if the event is not valid the IllegalArgumentException
  * will be thrown.
  * @param <code>id</code> the specified id.
  */
