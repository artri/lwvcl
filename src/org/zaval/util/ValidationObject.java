 ...
 * be inherited with other classes. It is necessary to implement <code>recalc</code>
 * method of the class, the method will be executed when the the validation process
 * has been performed with <code>validate</code> method and the object is not valid.
 * It means that the implementation guarantees that <code>recalc</code> method will be
 * executed only if it is realy necessary.
 */
public abstract class ValidationObject
implements Validationable
{
   protected boolean isValidFlag = false;

   public /*C#virtual*/ void invalidate() {
     if (isValidFlag) isValidFlag = false;
   }
  ...
  /**
   * Invoked with <code>validate</code> method in a case if the object is not valid.
   */
