...
extends ListenerSupport
{
  ...
  * specified listener. In this case the class is used to delivery the TextEvent
  * to the TextListener.
  ...
  */
  ...
  {
    TextListener le = (TextListener)l;
    TextEvent    oe = (TextEvent)e;
    switch (oe.getID())
    {
      case TextEvent.INSERTED: le.textInserted(oe); break;
      case TextEvent.REMOVED : le.textRemoved (oe); break;
      case TextEvent.UPDATED : le.textUpdated (oe); break;
    }
  }
}
