...
public class LwTreeCustomViewSample
extends LwSample
{

  public /*C#override*/ LwPanel createSamplePanel()
  {
    LwPanel r = new LwPanel();
    ...
    tree.setViewProvider(new LwTreeCustomViewSample.LwCustomViewProvider());
    r.setLwLayout(new LwBorderLayout());
    r.add (LwBorderLayout.CENTER, tree);
    return r;
  }

  public static void main (String[] args) {
    runSampleApp(250, 180, new LwTreeCustomViewSample());
  }
  ...
  implements LwViewProvider
  {
    public LwView getView(Drawable d, Object obj)
    {
       ...
       LwImage  icon = new LwImage("samples/img/lw.gif");
       String    value = (String)((Item)obj).getValue();
       LwLabel   title = new LwLabel(value);
       panel.add (icon);
       panel.add (title);
