...
implements Cursorable
{
   public /*C#override*/ LwPanel createSamplePanel()
   {
     ...
     LwCanvas canvas = new LwCanvas();
     canvas.getViewMan(true).setBorder("br.plain");
     canvas.setSize(100, 100);
     canvas.setLocation(30, 30);
     root.add (canvas);
     LwToolkit.getCursorManager().setCursorable(canvas, new LwCursorSample2());

     return root;
   }

   public static void main (String[] args)  {
     runSampleApp(300, 300,  new LwCursorSample2());
   }
