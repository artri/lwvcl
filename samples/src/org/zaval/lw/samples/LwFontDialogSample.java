...
public class LwFontDialogSample
extends LwSample
implements LwActionListener
{
  ...
  public /*C#override*/ void started()
  {
    ...
    LwFontPanel   panel      = new LwFontPanel();
    LwBlankDialog fileDialog = new LwBlankDialog(panel);
    fileDialog.setSize(300, 250);
  ...
  public void actionPerformed(LwActionEvent e) {
    System.out.println ("Selected Font : " + (Font)e.getData());
  }

  public static void main (String[] args)  {
    runSampleApp(550, 500, new LwFontDialogSample());
  }
}
