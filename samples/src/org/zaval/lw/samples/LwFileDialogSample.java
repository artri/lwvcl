...
public class LwFileDialogSample
extends LwSample
implements LwActionListener
{
  ...
  public /*C#override*/ void started()
  {
    ...
    LwFilePanel   panel      = new LwFilePanel("src", new String[][] { {"Java File", "java" }, { "All Files", "*" } } );
  ...
  public void actionPerformed(LwActionEvent e) {
    System.out.println ("Selected File : " + (String)e.getData());
  }

  public static void main (String[] args)  {
    runSampleApp(550, 500, new LwFileDialogSample());
  }
}
